...
public class TabFactory {
  ...
  public ITabPanel createPanelForConduit(GuiExternalConnection gui, IConduit con) {
    ...
    if (con instanceof IConduit.IHasTabPanel) {
      return ((IConduit.IHasTabPanel) con).createPanelForConduit(gui, con);
    } else if (baseType.isAssignableFrom(IPowerConduit.class)) {
